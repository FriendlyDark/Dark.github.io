(function () {
    ...
    function addonStart() {
        ...
        var ads = '<div style="padding: 0.3em 0.3em; padding-top: 0;"><div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em;"><div style="line-height: 1.2;"><span style="color: #ffffff"><div style="text-align: center;">Тут могла быть<br> ваша</br><span style="color: #f3d900">реклама</span></span></div></div></div></div>'
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: (value) => {
                const pluginUrl = 'https://dark.github.io/scripts/notice.js';
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/rus_movie.js', 'rus_movie', '@bylampa', 'Rus_movie');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/rus_movie.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/rus_movie.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: (value) => {
                const pluginUrl = 'https://dark.github.io/scripts/inter_movie.js';

                if (value === '1') {
                    itemON(pluginUrl, 'Зарубежные Подборки', '@bylampa', 'inter_movie');
                } else if (value === '2') {
                    deletePlugin(pluginUrl);
                }
            },
            onRender: (item) => {
                ...
                // Изменяем цвет текста заголовка и скрываем установку
                $('.settings-param__name', item).css('color', '#f3d900');
                hideInstall();
                ...
                setTimeout(() => {
                    const statusContainer = $('<div class="settings-param__status one"></div>');
                    $('div[data-name="inter_movie"]').append(statusContainer);
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/in_quality.js', 'in_quality', '@bylampa', 'In_quality');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/in_quality.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/in_quality.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: (value) => {
                const pluginUrl = 'https://dark.github.io/scripts/back.js';
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/weather.js', 'Погода', '@lampishe', 'Weather');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/weather.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/weather.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/cub_off.js', 'Cub Off', '@scabrum', 'Cub_off');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/cub_off.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/cub_off.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/interface.js', 'Стильный Интерфейс', '@lampa', 'Style_interface_fix');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/interface.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/interface.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/cardify.js', 'Стильный Интерфейс', '@lampa', 'Cardify');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/cardify.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/cardify.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/snow.js', 'Снег', '@undefined', 'Snow');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/snow.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/snow.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/start.js', 'Start', '@scabrum', 'Start');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/start.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/start.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/gold_theme.js', 'Золотая тема', '@dark', 'goldtheme');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/gold_theme.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/gold_theme.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/source.js', 'Дополнительные Источники', '@scabrum', 'New_source');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/source.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/source.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'FCP',
                description: 'Улучшает вашу жизнь'
            },
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/fp.js', 'FCP', '@Serega007', 'fp');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/fp.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
                var myResult = checkPlugin('https://dark.github.io/scripts/fp.js')
                setTimeout(function () {
                    $('div[data-name="fp"]').append('<div class="settings-param__status one"></div>')
                    if (myResult) {
                        $('div[data-name="fp"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
                    } else {
                        $('div[data-name="fp"]').find('.settings-param__status').removeClass('active error wait').addClass('error')
                    }
                }, 100);
            }
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/redirect.js', 'Смена Сервера', '@scabrum', 'Redirect');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/redirect.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/redirect.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/cinema.js', 'cinema', '@cinema', 'Cinema');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/cinema.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/cinema.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/jackett.js', 'Переключение Парсеров', '@AndreyURL54', 'Switch_Parser');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/jackett.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/jackett.js')
                setTimeout(function () {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                if (value == '1') {
                    itemON('https://dark.github.io/scripts/tv.js', 'Hack TV', '@scabrum', 'Hack_TV');
                }
                if (value == '2') {
                    var pluginToRemoveUrl = "https://dark.github.io/scripts/tv.js";
                    deletePlugin(pluginToRemoveUrl);
                }
            },
            onRender: function (item) {
                $('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
                var myResult = checkPlugin('https://dark.github.io/scripts/tv.js')
                setTimeout(function () {
