(function () {
  ...
  (function () {
    ...
    function c() {
        ...
        a.open("GET", "https://185.87.48.42:8090/random_torr", true);
        a.onload = function () {
          if (a.status === 200) {
            var b = a.responseText;
            Lampa.Storage.set("torrserver_url_two", "http://" + b + ":8090");
          } else {
            console.error("Ошибка при получении IP-адреса:", a.status);
    ...
    function e() {
      ...
      if (Lampa.Storage.get("torrserv") == 0) {
        g();
      }
    ...
    Lampa.SettingsApi.addParam({
      ...
      onRender: function (a) {
        ...
        setTimeout(function () {
          ...
          $(".settings-param__name", a).css("color", "ffffff");
          $("div[data-name=\"torrserv\"]").insertAfter("div[data-name=\"torrserver_use_link\"]");
          if (Lampa.Storage.field("torrserv") == "1") {
            var b = document.querySelector("#app > div.settings > div.settings__content.layer--height > div.settings__body > div > div > div > div > div > div:nth-child(2)");
            Lampa.Controller.focus(b);
