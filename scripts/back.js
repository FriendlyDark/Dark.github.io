(function () {
  ...
  (function () {
    ...
    function c() {
      ...
      function n() {
        var a = $("<div style=\"text-align:right;\"><div style=\"min-height:360px;\"><iframe id=\"speedtest-iframe\" width=\"100%\" height=\"100%\" frameborder=\"0\"></iframe></div></div>");
        Lampa.Modal.open({
          title: "",
          html: a,
          size: "medium",
        ...
        var b = document.getElementById("speedtest-iframe");
        b.src = "http://speedtest.vokino.tv/?R=3";
      }
      function o() {
        Lampa.Storage.clear();
      }
      ...
      function s() {
        var a = Lampa.Controller.enabled().name;
        var b = [];
        ...
        if (localStorage.getItem("twitch") !== "1") {
          b.push({
            title: "<div class=\"settings-folder\" style=\"padding:0!important\"><div style=\"width:2.2em;height:1.7em;padding-right:.5em\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"1.2em\" height=\"1.2em\" viewBox=\"0 0 24 24\"><path fill=\"currentColor\" d=\"M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z\"/></svg></div><div style=\"font-size:1.3em\">Twitch</div></div>"
          });
        }
        ...
        Lampa.Select.show({
          ...
          onSelect: function b(a) {
            ...
            if (a.title == "<div class=\"settings-folder\" style=\"padding:0!important\"><div style=\"width:2.2em;height:1.7em;padding-right:.5em\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"1.2em\" height=\"1.2em\" viewBox=\"0 0 24 24\"><path fill=\"currentColor\" d=\"M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z\"/></svg></div><div style=\"font-size:1.3em\">Twitch</div></div>") {
      ...
      Lampa.Controller.listener.follow("toggle", function (a) {
        if (a.name == "select" && $(".selectbox__title").text() == Lampa.Lang.translate("title_out")) {
          Lampa.Select.hide();
          // TOLOOK
          setTimeout(function () {
            s();
